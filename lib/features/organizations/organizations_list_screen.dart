        ...
        builder: (context) {
          ...
          if (state.error != null) {
            return EmptyStateWidget.error(
              onRetry: () => ref.read(organizationListProvider(districtId).notifier).refresh(),
            );
          }
          if (state.items.isEmpty) return const EmptyStateWidget.noOrganizations();

          return RefreshIndicator(
            color: AppTheme.primaryBlue,
            onRefresh: () => ref.read(organizationListProvider(districtId).notifier).refresh(),
