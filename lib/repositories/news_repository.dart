...
/// Все запросы обязательно фильтруются по district — пользователь никогда
/// не должен видеть новости чужого района. Композитный индекс
/// (district ASC, createdAt DESC) должен быть создан в Firestore Console
/// (см. README) для корректной работы пагинации.
